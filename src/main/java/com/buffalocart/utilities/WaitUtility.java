...
public class WaitUtility {
	...
	public static void waitForElement(WebDriver driver, String target, Enum locatortype)//wait for elemnt to be editable
	{
	...
	public static void waitForElementClickable(WebDriver driver, String target, Enum locatortype)//wait for elemnt to be clickable
	{
		WebDriverWait wait = new WebDriverWait(driver, TimeUnit.SECONDS.toSeconds(EXPLICIT_WAIT));
		if (locatortype.equals(LocatorType.Id)) {
	...
	public static void waitForElementInvisible(WebDriver driver, String target, Enum locatortype) //wait for elemnt to be visible
	{
		WebDriverWait wait = new WebDriverWait(driver, TimeUnit.SECONDS.toSeconds(EXPLICIT_WAIT));
		if (locatortype.equals(LocatorType.Id)) {
